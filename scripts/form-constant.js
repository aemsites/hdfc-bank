...
// import ccFormConstant from '../creditcards/corporate-creditcard/cc-form-constant.js';
...
const nreFormConstant = {
  ...
  stylePath: '',
  functionsExportPath: '../../../liabilities/nre-Nro/nre-nro.js',
  functionsFormPaths: [
    '/content/forms/af/hdfc_haf/digital/account-opening-nre-nro',
  ],
};

const fdFormConstant = {
  // FD
  ...
  stylePath: '',
  functionsExportPath: '../../../creditcards/fd-card/fd-functions.js', // fd
  functionsFormPaths: [
    '/content/forms/af/hdfc_haf/digital/etb-fixed-deposit-cc',
    '/content/forms/af/hdfc_haf/digital/pvtestfdliencugtest',
    '/content/forms/af/hdfc_haf/digital/fd-lien-cug',
    '/content/forms/af/hdfc_haf/digital/fdlienprodtest',
  ],
};
...
const nreFormPath = mapFormPath(nreFormConstant?.functionsFormPaths, nreFormConstant?.functionsExportPath);
const fdFormPath = mapFormPath(fdFormConstant?.functionsFormPaths, fdFormConstant?.functionsExportPath);
